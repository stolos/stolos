"""
Django settings for stolos_watchd project.
...
SECRET_KEY = os.getenv('STOLOS_WATCHD_SECRET',
...
ROOT_URLCONF = 'stolos_watchd.urls'
...
WSGI_APPLICATION = 'stolos_watchd.wsgi.application'
