"""
Django settings for sister_watchd project.
...
SECRET_KEY = os.getenv('SISTER_WATCHD_SECRET',
...
ROOT_URLCONF = 'sister_watchd.urls'
...
WSGI_APPLICATION = 'sister_watchd.wsgi.application'
